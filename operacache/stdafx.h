...
extern CConfig conf;
extern InfoPanelLine InfoPanelLineArray[INFOLINES];

extern PanelMode PanelModesArray[2];
extern const farStr *ColumnTitles1[2];
extern const farStr *ColumnTitles2[3];
